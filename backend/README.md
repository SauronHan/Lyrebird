...
A beautiful, modern web application for AI-powered voice synthesis using Microsoft's Lyrebird model. Generate natural-sounding speech from text with custom voice profiles.

![Lyrebird Studio](https://img.shields.io/badge/Lyrebird-Studio-purple?style=for-the-badge&logo=microphone)
...
<figcaption>Lyrebird Studio end-to-end TTS, voice library, and multi-speaker demo.</figcaption>
...
PORT=8000
DEBUG=False
MODEL_PATH=microsoft/Lyrebird-1.5B
DEVICE=cuda
CFG_SCALE=1.3
SAMPLE_RATE=24000
```
...
* Microsoft Lyrebird team
* FastAPI community
* Contributors & users

## 📞 Support

* Issues: [GitHub Issues](https://github.com/shamspias/Lyrebird-app/issues)

## 🔗 Links

* [Lyrebird Model](https://github.com/microsoft/Lyrebird)
